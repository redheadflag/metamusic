...
def convert(
    ...
    cmd = [
        ...
        "-i", src,
        *audio_opts,
        # Carry through the clean tags the backend already embedded,
        # but strip the encoder field that FFmpeg writes by default
        # (it would otherwise appear as e.g. "Lavf61.7.100" in Navidrome).
        "-map_metadata", "0",
        "-metadata", "encoder=",
        "-id3v2_version", "3",
        dest,
